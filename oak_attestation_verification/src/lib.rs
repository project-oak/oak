...
use oak_proto_rust::oak::attestation::v1::{
    Endorsement, EndorsementDetails, EndorsementReferenceValue, PesEndorsementReferenceValue,
    SignedEndorsement,
};
...
///
/// `now_utc_millis`: Current time in milliseconds UTC since Unix epoch.
/// `endorsement`: The underlying endorsement.
/// `pes_confirmation`: The PES confirmation bytes.
/// `ref_value`: Reference value containing PES public keys for verification.
pub fn verify_pes_endorsement(
    ...
    let s = pes::verify_pes_endorsement(
