...
use crate::core::any::Any;
use crate::core::cell::UnsafeCell;
use crate::core::fmt;
use crate::core::num::NonZeroU64;
use crate::core::mem;
use crate::core::sync::atomic::AtomicUsize;
use crate::core::sync::atomic::Ordering::SeqCst;
use crate::alloc::str;
...
///
///
pub type Result<T> = crate::core::result::Result<T, Box<dyn Any + Send + 'static>>;
...
unsafe fn spawn_unchecked<'a, F, T>(f: F) -> io::Result<JoinHandle<T>> where
    F: FnOnce() -> T, F: Send + 'a, T: Send + 'a
{
