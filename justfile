...
oak_containers_hello_world_untrusted_app:
    env --chdir=oak_containers_hello_world_untrusted_app cargo build --release
...
kokoro_oak_containers: stage0_bin stage1_cpio oak_containers_kernel oak_containers_system_image oak_containers_hello_world_container_bundle_tar oak_containers_hello_world_untrusted_app
    cargo nextest run --all-targets --hide-progress-bar --nocapture --package="oak_containers_hello_world_untrusted_app"
