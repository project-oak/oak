...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_oak_5fabi_2fproto_2fidentity_2eproto;
namespace oak {
namespace identity {
...
PROTOBUF_NAMESPACE_OPEN
template<> ::oak::identity::SignedChallenge* Arena::CreateMaybeMessage<::oak::identity::SignedChallenge>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace oak {
namespace identity {
...
class SignedChallenge :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:oak.identity.SignedChallenge) */ {
 public:
  SignedChallenge();
  virtual ~SignedChallenge();

  SignedChallenge(const SignedChallenge& from);
  SignedChallenge(SignedChallenge&& from) noexcept
    : SignedChallenge() {
    *this = ::std::move(from);
  }
  ...
  static inline const SignedChallenge* internal_default_instance() {
    return reinterpret_cast<const SignedChallenge*>(
               &_SignedChallenge_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    0;

  friend void swap(SignedChallenge& a, SignedChallenge& b) {
    a.Swap(&b);
  }
  ...
  inline SignedChallenge* New() const final {
    return CreateMaybeMessage<SignedChallenge>(nullptr);
  }
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_oak_5fabi_2fproto_2fidentity_2eproto);
    return ::descriptor_table_oak_5fabi_2fproto_2fidentity_2eproto.file_level_metadata[kIndexInFileMessages];
  }
