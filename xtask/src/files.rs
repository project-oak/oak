...
fn is_ignored_path(path: &Path) -> bool {
    ...
    components.contains(&std::path::Component::Normal(".git".as_ref()))
        ...
        || path_str.contains("/tflite_micro/generated/") // Generated TensorFlow Lite for Microcontrollers sources.
        || path_str.contains("/oak/libc/") // A minimized mix of libc implementations from multiple
