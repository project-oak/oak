...
http_archive(
    ...
    patches = [
        # "@//third_party/wabt:001-Add-bazel-support.patch",
        # "@//third_party/wabt:002-Make-bazel-rule-public.patch",
        ...
        # "@//third_party/wabt:008-Add-public-BUILD-targets-for-wat2wasm-wasm2wat.patch",
