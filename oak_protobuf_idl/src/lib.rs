...
impl From<oak_idl::Status> for proto::Status {
    fn from(value: oak_idl::Status) -> Self {
        proto::Status {
...
impl From<proto::Status> for oak_idl::Status {
    fn from(value: proto::Status) -> Self {
        oak_idl::Status::new_with_message((value.code as u32).into(), value.message)
    }
}

/// Creates a [`Response`] representing an error.
pub fn error_response(error: oak_idl::Status) -> Response {
    Response {
...
///
/// This function is intended to be used by code generated by the `oak_protobuf_idl_build` crate.
