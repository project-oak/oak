 ...
 * Signature: ([B[B)Lcom/google/oak/crypto/hpke/Hpke/SenderContext;
 */
 ...
 * Signature: ([BLcom/google/oak/crypto/hpke/KeyPair;[B)Lcom/google/oak/crypto/hpke/Hpke/RecipientContext;
 */
