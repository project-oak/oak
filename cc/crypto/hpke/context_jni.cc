...
JNIEXPORT jbyteArray JNICALL Java_com_google_oak_crypto_hpke_Context_00024SenderRequestContext_nativeSeal
  ...
  env->GetByteArrayRegion (associated_data, 0, associated_data_len, reinterpret_cast<jbyte*>(associated_data_buf));
  ...
  oak::crypto::SenderRequestContext* sender_request_context = (oak::crypto::SenderRequestContext*)(env->GetLongField(obj, fid));
...
JNIEXPORT jbyteArray JNICALL Java_com_google_oak_crypto_hpke_Context_00024SenderResponseContext_nativeOpen
  ...
  oak::crypto::SenderResponseContext* sender_response_context = (oak::crypto::SenderResponseContext*)(env->GetLongField(obj, fid));
...
JNIEXPORT jbyteArray JNICALL Java_com_google_oak_crypto_hpke_Context_00024RecipientRequestContext_nativeOpen
  ...
  oak::crypto::RecipientRequestContext* recipient_request_context = (oak::crypto::RecipientRequestContext*)(env->GetLongField(obj, fid));
...
JNIEXPORT jbyteArray JNICALL Java_com_google_oak_crypto_hpke_Context_00024RecipientResponseContext_nativeSeal
  ...
  oak::crypto::RecipientResponseContext* recipient_response_context = (oak::crypto::RecipientResponseContext*)(env->GetLongField(obj, fid));
