resource "google_service_account" "trusted_model" {
...
resource "google_project_iam_member" "workload_user" {
  ...
  member  = "serviceAccount:${google_service_account.trusted_model.email}"
}
...
module "confidential_space_instance" {
  ...
  service_account_email = google_service_account.trusted_model.email
