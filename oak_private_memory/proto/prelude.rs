...
pub mod v1 {
    pub use crate::oak::private_memory::{
        ...
        GetDatabaseMetricsRequest, GetDatabaseMetricsResponse, GetMemoriesByIdRequest,
        GetMemoriesByIdResponse, GetMemoriesRequest, GetMemoriesResponse, GetMemoryByIdRequest,
        GetMemoryByIdResponse, GetMemoryByNameRequest, GetMemoryByNameResponse,
