...
pub mod v1 {
    pub use crate::oak::private_memory::{
        ...
        DeleteMemoryResponse, Embedding, EmbeddingFilter, EmbeddingSort, EncryptedDataBlob,
        EncryptedMetadataBlob, EncryptedUserInfo, GetDatabaseMetricsRequest,
        GetDatabaseMetricsResponse, GetMemoriesByIdRequest, GetMemoriesByIdResponse,
        ...
        PlainTextUserInfo, ResetMemoryRequest, ResetMemoryResponse, ResultMask,
        SealedMemoryCredentials, SealedMemoryRequest, SealedMemoryResponse,
        SealedMemorySessionRequest, SealedMemorySessionResponse, SearchMemoriesFilter,
        SearchMemoriesFilters, SearchMemoriesRequest, SearchMemoriesResponse,
        SearchMemoriesResultItem, SearchMemoriesSort, SortOrder, StringFilter, SyncDatabaseRequest,
