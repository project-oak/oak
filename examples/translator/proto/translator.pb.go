...
func init() {
	proto.RegisterType((*TranslateRequest)(nil), "oak.examples.translator.TranslateRequest")
	proto.RegisterType((*TranslateResponse)(nil), "oak.examples.translator.TranslateResponse")
}
...
var fileDescriptor_69211233243bb443 = []byte{
	...
	,
}
...
func (c *translatorClient) Translate(ctx context.Context, in *TranslateRequest, opts ...grpc.CallOption) (*TranslateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/oak.examples.translator.Translator/Translate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Translator_Translate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/oak.examples.translator.Translator/Translate",
	}
...
var _Translator_serviceDesc = grpc.ServiceDesc{
	ServiceName: "oak.examples.translator.Translator",
