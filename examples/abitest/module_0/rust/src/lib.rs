...
impl FrontendNode {
    fn test_channel_create_raw(&mut self) -> TestResult {
        ...
        unsafe {
            expect_eq!(
                OakStatus::ErrInvalidArgs.value() as u32,
    ...
    fn test_channel_close_raw(&mut self) -> TestResult {
        ...
        unsafe {
            ...
            expect_eq!(
                OakStatus::ErrBadHandle.value() as u32,
    ...
    fn test_channel_read_raw(&mut self) -> TestResult {
        ...
        unsafe {
            ...
            // Valid case.
            expect_eq!(
                OakStatus::ErrChannelEmpty.value() as u32,
                oak_abi::channel_read(
                    in_channel,
                    buf.as_mut_ptr(),
                    buf.capacity(),
    ...
    fn test_channel_wait_raw(&mut self) -> TestResult {
        ...
        unsafe {
            ...
            expect_eq!(
                ChannelReadStatus::InvalidChannel.value(),
                i32::from(space[8])
            );
            expect_eq!(
                ChannelReadStatus::ReadReady.value(),
                i32::from(space[9 + 8])
            );
            expect_eq!(
                ChannelReadStatus::NotReady.value(),
        ...
        unsafe {
            ...
            expect_eq!(ChannelReadStatus::ReadReady.value(), i32::from(space[8]));
        }
