...
./builder build \
 ...
 --output-folder "/tmp/build-outputs-$COMMIT_HASH" \
 --verbose

# Copy the generated binary to placer
cp /tmp/build-outputs/oak_restricted_kernel_simple_io_bin "$KOKORO_ARTIFACTS_DIR/latest/oak_restricted_kernel_simple_io_bin/$COMMIT_HASH"
