...
#
# Publishes the Privacy Anonymizer container image to Google Artifact Registry.
#
# Usage:
...
PROJECT_ID="$1"
REPOSITORY_NAME="$2"
IMAGE_NAME="compliance-anonymizer"
...
echo ""
echo "Anonymizer container published to: ${IMAGE_URL}"
