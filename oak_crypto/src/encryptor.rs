...
pub(crate) const TEST_ENCAPSULATED_PUBLIC_KEY: [u8; 32] = [
    85, 255, 224, 169, 132, 101, 176, 248, 95, 67, 86, 31, 44, 31, 230, 224, 226, 174, 242, 10,
    200, 162, 222, 196, 255, 25, 114, 64, 4, 15, 193, 89,
];
...
/// Encryptor state is initialized after receiving an initial request messagecontaining client's
