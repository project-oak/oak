...
Definition trace := list (state * list event_l).
...
Inductive step_node_ev (id: node_id): call -> state -> state -> list event_l -> Prop :=
    ...
    | SWriteChanDwnEv s nlbl han msg s' ell':
        ...
        step_node_ev id (WriteChannel han msg ell') s s' 
            [(nlbl ---> msg); (msg DWN nlbl |--> ell')]
        (* The notations used for events on this last line and others
        is in Events.v *)
