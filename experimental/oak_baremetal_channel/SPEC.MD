...
For message sent over more than two frames the first frame would have 0x0 set,
with all other flags of that frame being unset. The last frame would have 0x1
set, with all other flags being unset. Any frames in between would have no flags
set.
