...
impl KeyProvisioningRole {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            KeyProvisioningRole::Unspecified => "KEY_PROVISIONING_ROLE_UNSPECIFIED",
            KeyProvisioningRole::Leader => "LEADER",
            KeyProvisioningRole::Follower => "FOLLOWER",
        }
    }
...
impl KeyOrigin {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            KeyOrigin::Unspecified => "KEY_ORIGIN_UNSPECIFIED",
            KeyOrigin::Instance => "INSTANCE",
            KeyOrigin::Group => "GROUP",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
